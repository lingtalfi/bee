        ...
        window.beef = {
            util: {
                ...
                dynamize: function (obj) {
                    if ('undefined' === typeof obj.prototype.value) {
                        obj.prototype.value = null;
                    }

                    if ('undefined' === typeof obj.prototype.setValue) {
                        obj.prototype.setValue = function (value) {
                            this.value = value;
                        };
                    }

                    if ('undefined' === typeof obj.prototype.getValue) {
                        obj.prototype.getValue = function () {
                            return this.value;
                        };
                    }

                    if ('undefined' === typeof obj.prototype.build) {
            ...
            form: function (options) {
                ...
                for(var i in this.dynamicElements){
                    window.beef.util.dynamize(this.dynamicElements.constructor);
                }
                ...
                this.setRuleMethod = function (ruleName, callback) {
                ...
                this.post = function () {
                    ...
                    for (var controlName in this.rules) {
                        var rules = this.rules[controlName];
