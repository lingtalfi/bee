(function ($) {
    ...
    function resize(jDialog, dimensions) {
        ...
        if (null !== width) {
            ...
            if ('auto' === width) {
                width = jContent.get(0).scrollWidth + 20; // 20=approximate scroll bar width
            }
            props.width = width;
        ...
        if (null !== height) {
            var contentHeight;
            if ('auto' === height) {
                // resizing the content height will force the dialog to expand vertically as well
                contentHeight = jContent.get(0).scrollHeight;
            }
            else {
                props.height = height;
